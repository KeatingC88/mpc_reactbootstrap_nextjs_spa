...
interface End_User_Profile_Account_State {
...
interface End_User_Profile_Account_Action {
    type: string
    payload?: Partial<End_User_Profile_Account_State>
}

const initial_state: End_User_Profile_Account_State = {
    first_name: null,
    last_name: null,
    middle_name: null,
    maiden_name: null,
...
const End_User_Profile_Account_State_Reducer = (
    state: End_User_Profile_Account_State = initial_state,
    action: End_User_Profile_Account_Action
): End_User_Profile_Account_State => {
...
export default End_User_Profile_Account_State_Reducer