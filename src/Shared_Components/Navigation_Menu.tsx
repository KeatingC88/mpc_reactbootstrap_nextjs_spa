...
import {
    Load_All_Community_Users, Load_New_Token
...
export interface Navigation_Menu_Props {
...
const Navigation_Menu = () => {
    ...
    const {
        ...
        error,
        api
    }: Navigation_Menu_Props = useSelector((state: Current_Redux_State) => ({
        application: {
            community: {
    ...
    const [html_selected_language, set_html_selected_language] = useState(application.settings.current_language)
    ...
    const hide_language_modal_from_end_user = () => {
        ...
        set_html_selected_language(application.settings.current_language)
    }
    ...
    const lock_navigation_menu_to_top_of_screen = async () => {
        ...
        switch (true) {
            case application.settings.nav_lock === false:
                ...
                break
            case application.settings.nav_lock === true:
    ...
    const toggle_application_alignment = async () => {
        ...
        switch (application.settings.alignment) {
    ...
    const toggle_bootstrap_background_theme = () => {
        ...
        switch (application.settings.theme) {
            case 1:
                return `dark`
            case 0:
                return `light`
    ...
    const show_language_modal_to_end_user = () => {
        ...
        html +=
            `<option value="${application.settings.current_language.split(`-`)[0]}-${application.settings.current_language.split(`-`)[1]}">
                ${application.language_dictionaries[application.settings.current_language.split(`-`)[0]][application.settings.current_language.split(`-`)[1]][application.settings.current_language.split(`-`)[0].charAt(0).toUpperCase() + application.settings.current_language.split(`-`)[0].charAt(1) + application.settings.current_language.split(`-`)[1]]}
            </option>`
        for (let i in Object.keys(application.language_dictionaries)) {
            for (let j in Object.keys(application.language_dictionaries[Object.keys(application.language_dictionaries)[i]])) {
                if (`${Object.keys(application.language_dictionaries)[i]}-${Object.keys(application.language_dictionaries[Object.keys(application.language_dictionaries)[i]])[j]}` !== application.settings.current_language)
                    html +=
                        `<option value="${Object.keys(application.language_dictionaries)[i]}-${Object.keys(application.language_dictionaries[Object.keys(application.language_dictionaries)[i]])[j]}">
                            ${application.language_dictionaries[Object.keys(application.language_dictionaries)[i]][Object.keys(application.language_dictionaries[Object.keys(application.language_dictionaries)[i]])[j]][`${Object.keys(application.language_dictionaries)[i].charAt(0).toUpperCase() + Object.keys(application.language_dictionaries)[i].slice(1).toLowerCase()}${Object.keys(application.language_dictionaries[Object.keys(application.language_dictionaries)[i]])[j]}`]}
                        </option>`
            }
        }
    ...
    return (
        <>
            <Navbar className="flex-column" bg={toggle_bootstrap_background_theme()} style={{ zIndex: `8`, display: application.settings.navbar_css_display_value }} expand="lg" fixed={application.settings.nav_lock === true ? `top` : undefined }>
                    <Row>
                        <Col>
                            <p>{lbl.Language}</p>
                        </Col>
                ...
                <Row>
                    <Col className="text-center">
                        <Navbar.Toggle aria-controls="collapse-area" disabled={nav_lock_disable_button_value || application.settings.nav_lock} />
                        <Navbar.Collapse>
                                    ...
                                    <Row>
                                        ...
                                        <Col className="text-center">
                                            <Nav.Link onClick={() => toggle_night_mode()}>
                                                {application.settings.theme === 0 ? (
                                                    <>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-sun-fill" viewBox="0 0 16 16">
                                                ...
                                                {(application.settings.nav_lock) &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-unlock" viewBox="0 0 16 16">
                                        ...
                                        <Col className="text-center">
                                            <Nav.Link onClick={() => toggle_application_alignment()}>
                                                {(application.settings.alignment === "justify-content-start" || application.settings.alignment === "justify-content-center") &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                ...
                                                {(application.settings.alignment === "justify-content-end") &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                        ...
                                        <Col className="text-center">
                                            <Nav.Link onClick={() => toggle_application_grid_column_sizes()}>
                                                {(application.settings.grid_type === 1) &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-1-circle-fill" viewBox="0 0 16 16">
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-1-circle" viewBox="0 0 16 16">
                                                ...
                                                {(application.settings.grid_type === 2) &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-2-circle-fill" viewBox="0 0 16 16">
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-2-circle" viewBox="0 0 16 16">
                                                ...
                                                {(application.settings.grid_type === 3) &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-3-circle-fill" viewBox="0 0 16 16">
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-3-circle" viewBox="0 0 16 16">
                                                ...
                                                {(application.settings.grid_type === 4) &&
                                                    <>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-4-circle-fill" viewBox="0 0 16 16">
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-4-circle" viewBox="0 0 16 16">
                                            ...
                                            <>
                                                ...
                                                <Col className="text-center">
                                                    <Nav.Link onClick={() => { Navigate.push(`/integration`) }}>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-grid-fill" viewBox="0 0 16 16">
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-grid" viewBox="0 0 16 16">
                                                ...
                                                {!end_user.account.avatar_url_path &&
                                                        <>
                                                            <svg
                                                                onClick={() => { Navigate.push(`/identity`) }}
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                width="32"
                                                                height="32"
                                                                fill="currentColor"
                                                                className={`bi-person-circle d-inline-block align-top mt-2 rounded-circle`}
                                                                viewBox="0 0 16 16">
                                                            ...
                                                            {end_user.account.name &&
                                                                <>
                                                                    <br />{end_user.account.name.split(`#`)[0]}
                                                                </>
                                                            }
                                                        </>
                                                    }
                                                {end_user.account.avatar_url_path &&
                                                        <>
                                                            <img
                                                                onClick={() => { Navigate.push(`/identity`) }}
                                                                src={end_user.account.avatar_url_path}
                                                                width="32"
                                                                height="32"
                                                                className={`d-inline-block align-top mt-1 rounded-circle`}
                                                                alt={end_user.account.avatar_title ? end_user.account.avatar_title : ``}
                                                            />
                                                            <br />
                                                            {end_user.account.name ? end_user.account.name.split(`#`)[0] : `error-name-display`}
                                                        </>
                                                    }
                                                </Col>
                                                <Col className="text-center">
                                                    <Nav.Link onClick={() => show_logout_button_modal()}>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-power" viewBox="0 0 16 16">
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-power Night-Font" viewBox="0 0 16 16">
                                                                    <path d="M7.5 1v7h1V1h-1z" />
                                                                    <path d="M3 8.812a4.999 4.999 0 0 1 2.578-4.375l-.485-.874A6 6 0 1 0 11 3.616l-.501.865A5 5 0 1 1 3 8.812z" />
                                                                </svg>
                                                                <br />
                                            ...
                                            <>
                                                <Col className="text-center">
                                                    <Nav.Link onClick={() => { Navigate.push(`/login`) }}>
                                                        {application.settings.theme === 0 ? (
                                                            ...
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-door-open" viewBox="0 0 16 16">
                                                ...
                                                <Col className="d-flex justify-content-center align-items-center text-center">
                                                    <Nav.Link onClick={() => { Navigate.push(`/register`) }}>
                                                        {application.settings.theme === 0 ? (
                                                            <>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-pen-fill" viewBox="0 0 16 16">
                ...
                <Row>
                    <Col>
                        {alert_text && (application.settings.nav_lock) &&
            ...
            <Modal show={language_modal_show_value} onHide={hide_language_modal_from_end_user}>
                <Modal.Header closeButton>
                    <Modal.Title>
                        ...
                        {application.settings.current_language != html_selected_language &&
                            <>
                                <br /> {lbl.From} <img src={`${application.settings.flag}`} width="32px" height="32px" />
            ...
            <Offcanvas show={overlay_display_value} onHide={() => set_offcanvas_display_value(false)} placement="top" id="offcanvas-menu" className={application.settings.theme === 1 ? `Night-Canvas`:``}>
...
{/*                    <Row className="top-most-canvas-line"></Row>
                    <Row className="top-leftcorner-canvas-line"></Row>*/}
                    <Container fluid>
                        {!end_user.account.token &&
                            <>
