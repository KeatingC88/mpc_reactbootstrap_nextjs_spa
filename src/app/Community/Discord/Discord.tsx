            ...
            <Row className={`${props.application.settings.alignment}`}>
                <Col className={`${props.application.settings.grid_type === 1 ? "col-xs-12 col-sm-12 col-md-12 col-lg-12" : ""}`}>
                    ...
                    >
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" className="bi bi-discord d-inline-block align-top mt-2 rounded-circle" viewBox="0 0 16 16">
                        ...
                        <Card.Footer>
                            <Row>
                                <Col className="text-center">
                                    <p>{lbl.PleaseFollowDiscordRules}.</p>
                                </Col>
                            </Row>
                        </Card.Footer>
                    </Card>
...
export default Community_Discord