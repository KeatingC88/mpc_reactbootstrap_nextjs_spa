                    ...
                    >
                        ...
                        >
                            ...
                            {props.application.settings.theme === 0 ? (
                                <>
                                    <svg onClick={() => { Navigate.push(`/Login/User/Email`) }} xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                                ...
                                <>
                                    <svg onClick={() => { Navigate.push(`/Login/User/Email`) }} xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
