...
interface Email_Register_Props {
...
const Email_Register = () => {
    ...
    const {
        ...
        error,
        api
    }: Email_Register_Props = useSelector((state: Current_Redux_State) => ({
        application: {
            community: {
    ...
    (async () => {
        ...
        if (error.network.id === "Email-Account-Already-Registered") {
        ...
        if (error.network.id === null && form_submit_complete) {
