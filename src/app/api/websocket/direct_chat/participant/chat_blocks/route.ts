...
import { Fetch_End_User_Data_From_Cache_Server } from '../../Service'
...
export const POST = async (req: NextRequest) => {
    try {
        ...
        await axios.post(`${USERS_SERVER_ADDRESS}/WebSocket/Chat_Blocks/Participant`, {
            ...
            return NextResponse.json(response.data === "" ? [] : Fetch_End_User_Data_From_Cache_Server({ response_data: response.data, token: token }), { status: 200 })
        })
    } catch (err: any) {
