...
import '@CSS/Layout/Bootstrap/Modal.css'
...
export const metadata: Metadata = {
    ...
    authors: [{ name: `${META_TAG_AUTHOR}` }],
    creator: `${META_TAG_CREATOR}`
}*/
...
const RootLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    return (
        ...
        <html lang="en">
            ...
            <body data-theme="Light-Theme" style={{ paddingRight: '0px'}}>
                <App>
                    {children}
                </App>
            </body>
